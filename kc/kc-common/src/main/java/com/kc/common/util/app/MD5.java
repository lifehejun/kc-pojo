...
/**
 * @ClassName: MD5  
 * @Description: TODO MD5加密算法 keyBean 类实现了RSA Data Security, Inc.在提交给IETF 的RFC1321中的keyBean message-digest算法。
 * @author jason  
 * @date 2018-1-12
 */
public class MD5 {
	...
	public static String md5(String str) {
		MD5 m = new MD5();
		return m.getkeyBeanofStr(m.getkeyBeanofStr(str)).toUpperCase();
	}
}
