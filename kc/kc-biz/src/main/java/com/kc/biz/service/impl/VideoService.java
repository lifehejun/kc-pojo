...
public class VideoService implements IVideoService {
    ...
    public int insert(Video video) {
        throw new ApiException(BusinessCode.USER_RESP_2029.getCode(),new String[]{"78"});
    ...
    public Page<Video> queryByPage(Map<String, Object> params) throws ApiException {
        ...
        if (total > 0) {
            ...
            list.forEach(video -> {
                String vodType = video.getVodType();
                ...
                if(StringUtils.isNoneBlank(labelCodeList)){
                    ...
                    for (String labelCode: labelCodeArr){
                        VideoLabel videoLabel = videoLabelService.findByCode(vodType ,labelCode);
                        if(null != videoLabel){
